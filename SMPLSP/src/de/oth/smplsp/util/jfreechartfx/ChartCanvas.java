...
import de.oth.smplsp.util.jfreechartfx.interaction.AnchorHandlerFX;
import de.oth.smplsp.util.jfreechartfx.interaction.ChartMouseEventFX;
import de.oth.smplsp.util.jfreechartfx.interaction.ChartMouseListenerFX;
import de.oth.smplsp.util.jfreechartfx.interaction.DispatchHandlerFX;
import de.oth.smplsp.util.jfreechartfx.interaction.MouseHandlerFX;
import de.oth.smplsp.util.jfreechartfx.interaction.PanHandlerFX;
import de.oth.smplsp.util.jfreechartfx.interaction.ScrollHandlerFX;
import de.oth.smplsp.util.jfreechartfx.interaction.TooltipHandlerFX;
...
public class ChartCanvas extends Canvas implements ChartChangeListener {
     ...
     * 
     * @param chart
     *            the chart ({@code null} not permitted).
     */
     ...
     * 
     * @param anchor
     *            the anchor ({@code null} permitted).
     */
     ...
     *
     * @param listener
     *            the listener ({@code null} not permitted).
     */
     ...
     * 
     * @param id
     *            the ID ({@code null} not permitted).
     * 
     ...
     * 
     * @param handler
     *            the handler ({@code null} not permitted).
     */
     ...
     *
     * @param point
     *            the selection point (for subplot selection).
     *
