...
/**
 * Handles mouse move and click events on the {@link ChartCanvas} by dispatching
 * {@link ChartMouseEventFX} events to listeners that are registered with the
 * {@code ChartCanvas} (listeners can also be registered with a
 * {@link ChartViewer} control).
 * 
 * <p>
...
public class DispatchHandlerFX extends AbstractMouseHandlerFX {
     ...
     * 
     * @param id
     *            the id (<code>null</code> not permitted).
     */
     ...
     * pointer (so that later we can check that the click isn't part of a drag).
     * 
     * @param canvas
     *            the chart canvas.
     * @param e
    ...
    /**
     * Handles a mouse clicked event by setting the anchor point for the canvas
     * and redrawing the chart (the anchor point is a reference point used by
     * the chart to determine crosshair lines).
     * 
     * @param canvas
     *            the chart canvas (<code>null</code> not permitted).
     * @param e
