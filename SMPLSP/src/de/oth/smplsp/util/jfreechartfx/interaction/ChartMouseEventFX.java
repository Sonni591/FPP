...
/**
 * A mouse event for a chart that is displayed in a (JavaFX) {@link ChartViewer}
 * .
 *
 * @see ChartMouseListenerFX
 * 
 *      <p>
 *      THE API FOR THIS CLASS IS SUBJECT TO CHANGE IN FUTURE RELEASES. This is
...
public class ChartMouseEventFX extends EventObject implements Serializable {
     ...
     *
     * @param chart
     *            the source chart ({@code null} not permitted).
     * @param trigger
     *            the mouse event that triggered this event ({@code null} not
     *            permitted).
     * @param entity
     *            the chart entity (if any) under the mouse point ({@code null}
     *            permitted).
     */
