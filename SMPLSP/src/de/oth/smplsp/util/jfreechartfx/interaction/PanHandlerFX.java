...
/**
 * Handles panning of charts on a {@link ChartCanvas}. This handler should be
 * configured with the required modifier keys and installed as a live handler
 * (not an auxiliary handler).
 * 
 * <p>
