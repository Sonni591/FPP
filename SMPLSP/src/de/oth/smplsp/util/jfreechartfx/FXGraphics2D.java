...
package de.oth.smplsp.util.jfreechartfx;
...
public class FXGraphics2D extends Graphics2D {
    ...
    /**
     * Throws an {@code IllegalArgumentException} if {@code arg} is {@code null}
     * .
     * 
     * @param arg
     ...
     * 
     * @param gc
     *            the graphics context ({@code null} not permitted).
     */
     ...
     * JavaFX canvas - this attribute is the width that is used.
     * </p>
     * 
     * @return The width.
     */
     ...
     * 
     * @param width
     *            the new width (must be 0 or greater).
     */
     ...
     * correctly you have the option to disable it. See <a
     * href="https://javafx-jira.kenai.com/browse/RT-36891">
     ...
     * this method, it does nothing (in accordance with the JDK specification). <br>
     * <br>
     ...
     * 
     * @param paint
     *            the paint ({@code null} is permitted but ignored).
     * 
     * @see #getPaint()
     */
    @Override
	...
	if (paint instanceof Color) {
		...
		RadialGradient rg = new RadialGradient(focusAngle * Math.PI
			/ 180, focusDistance, center.getX(), center.getY(),
     ...
     * 
     * @param c
     *            the color ({@code null} permitted but ignored).
     * 
     * @see #setPaint(java.awt.Paint)
     */
    @Override
     ...
     * 
     * @param c
     *            the color ({@code null} not permitted).
     * 
     ...
     * 
     * @param comp
     *            the composite ({@code null} not permitted).
     * 
     * @see #getComposite()
     */
    @Override
     ...
     * 
     * @param hintKey
     *            the hint key ({@code null} permitted, but the result will be
     *            {@code null} also in that case).
     * 
     ...
     * 
     * @param hintKey
     *            the hint key ({@code null} not permitted).
     * @param hintValue
     *            the hint value.
     * 
     ...
     * 
     * @param hints
     *            the new set of hints ({@code null} not permitted).
     * 
     ...
     * 
     * @param hints
     *            the hints ({@code null} not permitted).
     */
    @Override
     ...
     * 
     * @param font
     *            the font ({@code null} is permitted but ignored).
     * 
     * @see #getFont()
     */
    @Override
	...
	FontPosture posture = font.isItalic() ? FontPosture.ITALIC
		: FontPosture.REGULAR;
	this.gc.setFont(javafx.scene.text.Font.font(font.getFamily(), weight,
		posture, font.getSize()));
    }
     ...
     * 
     * @param iterator
     *            an iterator for the characters.
     * @param x
     *            the x-coordinate.
     * @param y
     *            the x-coordinate.
     ...
     * 
     * @param iterator
     *            an iterator over the characters ({@code null} not permitted).
     * @param x
     *            the x-coordinate.
     * @param y
     *            the y-coordinate.
    ...
    public void drawString(AttributedCharacterIterator iterator, float x,
	    float y) {
	Set<AttributedCharacterIterator.Attribute> s = iterator
		.getAllAttributeKeys();
	if (!s.isEmpty()) {
     ...
     * 
     * @param g
     *            the glyph vector ({@code null} not permitted).
     * @param x
     *            the x-coordinate.
     * @param y
     *            the y-coordinate.
     ...
     * to the {@code transform} method: <br>
     * <br>
     * <ul>
     * <li>
     ...
     * 
     * @param t
     *            the transform ({@code null} not permitted).
     */
    @Override
     ...
     * 
     * @param t
     *            the new transform ({@code null} permitted, resets to the
     *            identity transform).
     * 
     * @see #getTransform()
     */
     ...
     * 
     * @param rect
     *            a rectangle (in device space).
     * @param s
     *            the shape.
     * @param onStroke
     *            test the stroked outline only?
     * 
     * @return A boolean.
     */
    @Override
	...
	Shape ts;
	if (onStroke) {
	    ts = this.transform.createTransformedShape(this.stroke
     ...
     * 
     * @param shape
     *            the new user clipping region ({@code null} permitted).
     * 
     * @see #getClip()
     */
    @Override
     ...
     * 
     * @param s
     *            the clip shape ({@code null} not permitted).
     */
    @Override
    ...
    /**
     * Draws an arc contained within the rectangle {@code (x, y, width, height)}
     * , starting at {@code startAngle} and continuing through {@code arcAngle}
     * degrees using the current {@code paint} and {@code stroke}.
     * 
     * @param x
     *            the x-coordinate.
     * @param y
     ...
     *            the height.
     * @param startAngle
     *            the start angle in degrees, 0 = 3 o'clock.
     * @param arcAngle
    ...
    /**
     * Fills an arc contained within the rectangle {@code (x, y, width, height)}
     * , starting at {@code startAngle} and continuing through {@code arcAngle}
     * degrees, using the current {@code paint}.
     * 
     * @param x
     *            the x-coordinate.
     * @param y
     ...
     *            the y-points.
     * @param nPoints
     *            the number of points to use for the polygon.
     * 
     ...
     * @return A polygon.
     */
    public GeneralPath createPolygon(int[] xPoints, int[] yPoints, int nPoints,
	    boolean close) {
     ...
     *            the y-coordinate.
     * @param width
     *            the width of the target rectangle for the image.
     * @param height
     *            the height of the target rectangle for the image.
     * @param observer
     *            ignored.
     * 
     * @return {@code true} if the image is drawn.
     ...
     *            the y-coordinate.
     * @param bgcolor
     *            the background color ({@code null} permitted).
     * @param observer
     *            ignored.
     * 
     * @return {@code true} if the image is drawn.
     ...
     *            the image.
     * @param dx1
     *            the x-coordinate for the top left of the destination.
     * @param dy1
     *            the y-coordinate for the top left of the destination.
     * @param dx2
     *            the x-coordinate for the bottom right of the destination.
     * @param dy2
     *            the y-coordinate for the bottom right of the destination.
     * @param sx1
     *            the x-coordinate for the top left of the source.
     * @param sy1
     *            the y-coordinate for the top left of the source.
     * @param sx2
     *            the x-coordinate for the bottom right of the source.
     * @param sy2
     *            the y-coordinate for the bottom right of the source.
     * 
     * @return {@code true} if the image is drawn.
     */
    @Override
	...
	int w = dx2 - dx1;
	int h = dy2 - dy1;
	BufferedImage img2 = new BufferedImage(BufferedImage.TYPE_INT_ARGB, w,
		h);
	Graphics2D g2 = img2.createGraphics();
     ...
     *            the arc height.
     */
    private void setRoundRect(int x, int y, int width, int height,
	    int arcWidth, int arcHeight) {
	if (this.roundRect == null) {
	    this.roundRect = new RoundRectangle2D.Double(x, y, width, height,
		    arcWidth, arcHeight);
	} else {
	    this.roundRect.setRoundRect(x, y, width, height, arcWidth,
		    arcHeight);
	}
    }
